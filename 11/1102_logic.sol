...
// This is just a contract of a LGC Token.
// It is a ERC20 token
contract LGCToken is StandardToken, Ownable{
    
    string public version = "1.0";
    string public name = "LGC Token";
    ...
    // constructor
    function LGCToken(address _developer) { 
   ...
   */
    function mintLGC(address _to, uint256 _amount, uint256 _lockAmount, uint _releaseTime) onlyOwner canMint public returns (bool) {
